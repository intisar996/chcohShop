...
{
    /// <inheritdoc />
    public partial class addOrderdTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ByuerId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PicterUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Sugar = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    Fat = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemOrderd_ProductId = table.Column<int>(type: "int", nullable: true),
                    ItemOrderd_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
