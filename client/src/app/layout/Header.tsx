...
import header from  '../../../public/images/header3.jpg'
...
export default function Header({title,text } :Props) {
    ...
    return (
        ...
        <Box style={homeHeader} sx={{ py: 5, p: { xs:'10px !important'} }} className="home-header">
            <Grid container spacing={2} display='flex' justifyContent='center' alignItems='center' flexDirection='column' height='100%' position='relative'>
                <Grid size={{ xs: 12, md: 8 }} sx={{ backgroundColor: '#e6d7c35c', p: { xs: 3, md: 6 }, fontSize: {xs:'2rem !important'} ,borderRadius:10 } } position='relative' overflow='hidden' >
                ...
                <Typography variant='body1' className='choco-p'>
                        {text}
                </Typography>
                    <svg className='chobar' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1077 343.79" >
                        <g>
